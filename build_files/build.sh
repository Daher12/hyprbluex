...
dnf5 install -y dbus-daemon xdg-user-dirs kitty tlp libappstream-glib fish blueman iwd nautilus hyprland hyprpaper hypridle hyprlock hyprpolkitagent hyprshot uwsm newt nwg-look sbctl nautilus-open-any-terminal tailscale --setopt=install_weak_deps=False
